...
export async function listDocuments() { return request("/documents/"); }
...
export async function listChatSessions() { return request("/chat/sessions"); }
...
export async function expandDataset(titles: string[]): Promise<ExpandResponse> {
  return request("/explorer/expand", {
    method: "POST",
